...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    wasmTable = wasmExports["nj"];
    addOnInit(wasmExports["ij"]);
...
var YaGamesPrivate = {
  ...
  _callback_number: null,
  _callback_bool: null,
  toErrStr: function toErrStr(err) {
    return err + "";
  },
  ...
  send: function send(cb_id, message_id, message) {
    if (YaGamesPrivate._callback_object) {
      ...
      switch (_typeof(message)) {
        case "undefined":
          getWasmTableEntry(YaGamesPrivate._callback_empty)(cb_id, cmsg_id);
          break;
        case "number":
          getWasmTableEntry(YaGamesPrivate._callback_number)(cb_id, cmsg_id, message);
          break;
        case "string":
          var msg = stringToNewUTF8(message);
          getWasmTableEntry(YaGamesPrivate._callback_string)(cb_id, cmsg_id, msg, lengthBytesUTF8(message));
          _free(msg);
          break;
        case "object":
          var obj_str = JSON.stringify(message);
          var msg = stringToNewUTF8(obj_str);
          getWasmTableEntry(YaGamesPrivate._callback_object)(cb_id, cmsg_id, msg, lengthBytesUTF8(obj_str));
          _free(msg);
          break;
        case "boolean":
          var msg = message ? 1 : 0;
          getWasmTableEntry(YaGamesPrivate._callback_bool)(cb_id, cmsg_id, msg);
          break;
        default:
          console.warn("Unsupported message format: " + _typeof(message));
      }
  ...
  delaySend: function delaySend(cb_id, message_id, message) {
    setTimeout(function () {
      YaGamesPrivate.send(cb_id, message_id, message);
    }, 0);
  }
};
var _YaGamesPrivate_Adv_GetBannerAdvStatus = function _YaGamesPrivate_Adv_GetBannerAdvStatus(cb_id) {
  var self = YaGamesPrivate;
  try {
    self._ysdk.adv.getBannerAdvStatus().then(function (result) {
...
var _YaGamesPrivate_Adv_HideBannerAdv = function _YaGamesPrivate_Adv_HideBannerAdv(cb_id) {
  var self = YaGamesPrivate;
  try {
    self._ysdk.adv.hideBannerAdv().then(function (result) {
      self.send(cb_id, null, JSON.stringify(result));
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
var _YaGamesPrivate_Adv_ShowBannerAdv = function _YaGamesPrivate_Adv_ShowBannerAdv(cb_id) {
  var self = YaGamesPrivate;
  try {
    self._ysdk.adv.showBannerAdv().then(function (result) {
      self.send(cb_id, null, JSON.stringify(result));
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
var _YaGamesPrivate_Adv_ShowFullscreenAdv = function _YaGamesPrivate_Adv_ShowFullscreenAdv(cb_id) {
  var self = YaGamesPrivate;
  try {
...
var _YaGamesPrivate_Adv_ShowRewardedVideo = function _YaGamesPrivate_Adv_ShowRewardedVideo(cb_id) {
  var self = YaGamesPrivate;
  try {
...
function _YaGamesPrivate_Banner_Init(cb_id) {
  var self = YaGamesPrivate;
  self.delaySend(cb_id, "DEPRECATED.");
}
var _YaGamesPrivate_Clipboard_WriteText = function _YaGamesPrivate_Clipboard_WriteText(cb_id, ctext) {
  var self = YaGamesPrivate;
  try {
    var text = UTF8ToString(ctext);
    self._ysdk.clipboard.writeText(text).then(function () {
...
function _YaGamesPrivate_DeviceInfo_IsDesktop() {
  return YaGamesPrivate._ysdk.deviceInfo.isDesktop();
}
function _YaGamesPrivate_DeviceInfo_IsMobile() {
  return YaGamesPrivate._ysdk.deviceInfo.isMobile();
}
function _YaGamesPrivate_DeviceInfo_IsTV() {
  return YaGamesPrivate._ysdk.deviceInfo.isTV();
}
function _YaGamesPrivate_DeviceInfo_IsTablet() {
...
function _YaGamesPrivate_Event_Dispatch(cevent_name) {
  var self = YaGamesPrivate;
  var event_name = UTF8ToString(cevent_name);
  self._ysdk.dispatchEvent(self._ysdk.EVENTS[event_name]);
}
var _YaGamesPrivate_Event_On = function _YaGamesPrivate_Event_On(cevent_name, cb_id) {
  var self = YaGamesPrivate;
  var event_name = UTF8ToString(cevent_name);
  try {
    self._ysdk.onEvent(self._ysdk.EVENTS[event_name], function () {
      self.send(cb_id, null);
    });
  } catch (err) {
    self.delaySend(cb_id, self.toErrStr(err));
...
var _YaGamesPrivate_Feedback_CanReview = function _YaGamesPrivate_Feedback_CanReview(cb_id) {
  var self = YaGamesPrivate;
  try {
    self._ysdk.feedback.canReview().then(function (result) {
      self.send(cb_id, null, JSON.stringify(result));
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
var _YaGamesPrivate_Feedback_RequestReview = function _YaGamesPrivate_Feedback_RequestReview(cb_id) {
  var self = YaGamesPrivate;
  try {
    self._ysdk.feedback.requestReview().then(function (result) {
      self.send(cb_id, null, JSON.stringify(result));
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
function _YaGamesPrivate_GetFlags(cb_id, coptions) {
  var self = YaGamesPrivate;
  try {
    var options = coptions === 0 ? {} : self.parseJson(UTF8ToString(coptions));
    self._ysdk.getFlags(options).then(function (flags) {
...
var _YaGamesPrivate_GetLeaderboards = function _YaGamesPrivate_GetLeaderboards(cb_id) {
  var self = YaGamesPrivate;
  try {
    self._ysdk.getLeaderboards().then(function (lb) {
      self._lb = lb;
      self.send(cb_id);
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
...
var _YaGamesPrivate_GetPayments = function _YaGamesPrivate_GetPayments(cb_id, coptions) {
  var self = YaGamesPrivate;
  try {
    var options = self.parseJson(UTF8ToString(coptions));
    self._ysdk.getPayments(options).then(function (payments) {
...
var _YaGamesPrivate_GetPlayer = function _YaGamesPrivate_GetPlayer(cb_id, coptions) {
  var self = YaGamesPrivate;
  try {
    var options = self.parseJson(UTF8ToString(coptions));
    self._ysdk.getPlayer(options).then(function (player) {
      self._player = player;
      self.send(cb_id);
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
...
var _YaGamesPrivate_GetStorage = function _YaGamesPrivate_GetStorage(cb_id) {
  var self = YaGamesPrivate;
  try {
    self._ysdk.getStorage().then(function (storage) {
...
var _YaGamesPrivate_IsAvailableMethod = function _YaGamesPrivate_IsAvailableMethod(cb_id, cname) {
  var self = YaGamesPrivate;
  try {
    var name = UTF8ToString(cname);
    self._ysdk.isAvailableMethod(name).then(function (result) {
...
var _YaGamesPrivate_Leaderboards_GetDescription = function _YaGamesPrivate_Leaderboards_GetDescription(cb_id, cleaderboard_name) {
  var self = YaGamesPrivate;
  try {
    var leaderboard_name = UTF8ToString(cleaderboard_name);
    self._lb.getLeaderboardDescription(leaderboard_name).then(function (result) {
      self.send(cb_id, null, JSON.stringify(result));
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
var _YaGamesPrivate_Leaderboards_GetEntries = function _YaGamesPrivate_Leaderboards_GetEntries(cb_id, cleaderboard_name, coptions) {
  var self = YaGamesPrivate;
  try {
    var leaderboard_name = UTF8ToString(cleaderboard_name);
    var options = self.parseJson(UTF8ToString(coptions));
    self._lb.getLeaderboardEntries(leaderboard_name, options).then(function (result) {
      if (result.entries) {
...
var _YaGamesPrivate_Leaderboards_GetPlayerEntry = function _YaGamesPrivate_Leaderboards_GetPlayerEntry(cb_id, cleaderboard_name, coptions) {
  var self = YaGamesPrivate;
  try {
    var leaderboard_name = UTF8ToString(cleaderboard_name);
    var options = self.parseJson(UTF8ToString(coptions));
    self._lb.getLeaderboardPlayerEntry(leaderboard_name).then(function (result) {
...
function _YaGamesPrivate_Leaderboards_SetScore(cb_id, cleaderboard_name, score, cextra_data) {
  var self = YaGamesPrivate;
  try {
    var leaderboard_name = UTF8ToString(cleaderboard_name);
    var promise;
...
var _YaGamesPrivate_OpenAuthDialog = function _YaGamesPrivate_OpenAuthDialog(cb_id) {
  var self = YaGamesPrivate;
  try {
    self._ysdk.auth.openAuthDialog().then(function () {
      self.send(cb_id);
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
var _YaGamesPrivate_Payments_ConsumePurchase = function _YaGamesPrivate_Payments_ConsumePurchase(cb_id, cpurchase_token) {
  var self = YaGamesPrivate;
  try {
    var purchase_token = UTF8ToString(cpurchase_token);
    self._payments.consumePurchase(purchase_token).then(function () {
      self.send(cb_id, null);
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
function _YaGamesPrivate_Payments_GetCatalog(cb_id, coptions) {
  var self = YaGamesPrivate;
  try {
    var options = coptions === 0 ? {} : self.parseJson(UTF8ToString(coptions));
    self._payments.getCatalog().then(function (products) {
...
var _YaGamesPrivate_Payments_GetPurchases = function _YaGamesPrivate_Payments_GetPurchases(cb_id) {
  var self = YaGamesPrivate;
  try {
    self._payments.getPurchases().then(function (purchases) {
      var tmp = {
        purchases: [],
...
var _YaGamesPrivate_Payments_Purchase = function _YaGamesPrivate_Payments_Purchase(cb_id, coptions) {
  var self = YaGamesPrivate;
  try {
    var options = self.parseJson(UTF8ToString(coptions));
    self._payments.purchase(options).then(function (p) {
      var tmp = {
        developerPayload: p.developerPayload,
        productID: p.productID,
        purchaseTime: p.purchaseTime,
...
var _YaGamesPrivate_Player_GetData = function _YaGamesPrivate_Player_GetData(cb_id, ckeys) {
  var self = YaGamesPrivate;
  try {
    var keys = ckeys === 0 ? undefined : self.parseJson(UTF8ToString(ckeys));
    self._player.getData(keys).then(function (result) {
      self.send(cb_id, null, JSON.stringify(result));
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
function _YaGamesPrivate_Player_GetID() {
  var self = YaGamesPrivate;
  var cid = stringToNewUTF8("" + self._player.getID());
  return cid;
}
var _YaGamesPrivate_Player_GetIDsPerGame = function _YaGamesPrivate_Player_GetIDsPerGame(cb_id) {
  var self = YaGamesPrivate;
  try {
    self._player.getIDsPerGame().then(function (arr) {
...
function _YaGamesPrivate_Player_GetMode() {
  var self = YaGamesPrivate;
  var cmode = stringToNewUTF8(self._player.getMode());
  return cmode;
}
function _YaGamesPrivate_Player_GetName() {
  var self = YaGamesPrivate;
  var cname = stringToNewUTF8(self._player.getName());
  return cname;
}
function _YaGamesPrivate_Player_GetPayingStatus() {
  var self = YaGamesPrivate;
  var cstatus = stringToNewUTF8(self._player.getPayingStatus());
  return cstatus;
}
function _YaGamesPrivate_Player_GetPersonalInfo() {
  var self = YaGamesPrivate;
...
function _YaGamesPrivate_Player_GetPhoto(csize) {
  var self = YaGamesPrivate;
  var size = UTF8ToString(csize);
  var cname = stringToNewUTF8(self._player.getPhoto(size));
  return cname;
}
function _YaGamesPrivate_Player_GetSignature() {
  var self = YaGamesPrivate;
...
var _YaGamesPrivate_Player_GetStats = function _YaGamesPrivate_Player_GetStats(cb_id, ckeys) {
  var self = YaGamesPrivate;
  try {
    var keys = ckeys === 0 ? undefined : self.parseJson(UTF8ToString(ckeys));
    self._player.getStats(keys).then(function (result) {
      self.send(cb_id, null, JSON.stringify(result));
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
function _YaGamesPrivate_Player_GetUniqueID() {
  var self = YaGamesPrivate;
  var cid = stringToNewUTF8(self._player.getUniqueID());
  return cid;
}
var _YaGamesPrivate_Player_IncrementStats = function _YaGamesPrivate_Player_IncrementStats(cb_id, cincrements) {
  var self = YaGamesPrivate;
  try {
    var increments = self.parseJson(UTF8ToString(cincrements));
    self._player.incrementStats(increments).then(function (result) {
      self.send(cb_id, null, JSON.stringify(result));
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
var _YaGamesPrivate_Player_SetData = function _YaGamesPrivate_Player_SetData(cb_id, cdata, flush) {
  var self = YaGamesPrivate;
  try {
    var data = self.parseJson(UTF8ToString(cdata));
    self._player.setData(data, flush).then(function () {
      self.send(cb_id);
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
var _YaGamesPrivate_Player_SetStats = function _YaGamesPrivate_Player_SetStats(cb_id, cstats) {
  var self = YaGamesPrivate;
  try {
    var stats = self.parseJson(UTF8ToString(cstats));
    self._player.setStats(stats).then(function () {
      self.send(cb_id);
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
function _YaGamesPrivate_RegisterCallbacks(callback_object, callback_string, callback_empty, callback_number, callback_bool) {
  var self = YaGamesPrivate;
...
function _YaGamesPrivate_RemoveCallbacks() {
  var self = YaGamesPrivate;
...
var _YaGamesPrivate_Screen_Fullscreen_Exit = function _YaGamesPrivate_Screen_Fullscreen_Exit(cb_id) {
  var self = YaGamesPrivate;
  try {
    self._ysdk.screen.fullscreen.exit().then(function () {
      self.send(cb_id, null);
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
var _YaGamesPrivate_Screen_Fullscreen_Request = function _YaGamesPrivate_Screen_Fullscreen_Request(cb_id) {
  var self = YaGamesPrivate;
  try {
    self._ysdk.screen.fullscreen.request().then(function () {
      self.send(cb_id, null);
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
function _YaGamesPrivate_Screen_Fullscreen_Status() {
...
var _YaGamesPrivate_Shortcut_CanShowPrompt = function _YaGamesPrivate_Shortcut_CanShowPrompt(cb_id) {
  var self = YaGamesPrivate;
  try {
    self._ysdk.shortcut.canShowPrompt().then(function (result) {
      self.send(cb_id, null, JSON.stringify(result));
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
var _YaGamesPrivate_Shortcut_ShowPrompt = function _YaGamesPrivate_Shortcut_ShowPrompt(cb_id) {
  var self = YaGamesPrivate;
  try {
    self._ysdk.shortcut.showPrompt().then(function (result) {
      self.send(cb_id, null, JSON.stringify(result));
    }).catch(function (err) {
      self.send(cb_id, self.toErrStr(err));
    });
...
function _YaGamesPrivate_Storage_Clear() {
  var self = YaGamesPrivate;
  self._storage.clear();
}
function _YaGamesPrivate_Storage_GetItem(ckey) {
  var self = YaGamesPrivate;
...
function _YaGamesPrivate_Storage_Key(n) {
  var self = YaGamesPrivate;
...
function _YaGamesPrivate_Storage_Length() {
  var self = YaGamesPrivate;
  return self._storage.length;
}
function _YaGamesPrivate_Storage_RemoveItem(ckey) {
  var self = YaGamesPrivate;
  var key = UTF8ToString(ckey);
  self._storage.removeItem(key);
}
function _YaGamesPrivate_Storage_SetItem(ckey, cvalue) {
  var self = YaGamesPrivate;
  var key = UTF8ToString(ckey);
...
function _YaMetrica_Hit(counterId, url, cOptions, cOptionsLen) {
  try {
...
function _YaMetrica_NotBounce(counterId, cOptions, cOptionsLen) {
  try {
    var options = cOptions === 0 ? {} : YaMetrica.parseJson(UTF8ToString(cOptions, cOptionsLen));
...
function _YaMetrica_Params(counterId, cVisitParams, cVisitParamsLen, cGoalParams, cGoalParamsLen) {
  try {
...
function _YaMetrica_ReachGoal(counterId, target, cParams, cParamsLen) {
  try {
...
function _YaMetrica_UserParams(counterId, cParams, cParamsLen) {
  try {
    var params = cParams === 0 ? {} : YaMetrica.parseJson(UTF8ToString(cParams, cParamsLen));
...
var wasmImports = {
  hj: _HtmlLoaderLibrary_Hide,
  gj: _HtmlLoaderLibrary_SetProgress,
  fj: _HtmlLoaderLibrary_SetText,
  ej: _HtmlLoaderLibrary_Show,
  dj: _JsToDef_RegisterCallbacks,
  cj: _JsToDef_RemoveCallbacks,
  bj: _YaGamesPrivate_Adv_GetBannerAdvStatus,
  aj: _YaGamesPrivate_Adv_HideBannerAdv,
  $i: _YaGamesPrivate_Adv_ShowBannerAdv,
  _i: _YaGamesPrivate_Adv_ShowFullscreenAdv,
  Zi: _YaGamesPrivate_Adv_ShowRewardedVideo,
  Yi: _YaGamesPrivate_Banner_Init,
  Xi: _YaGamesPrivate_Clipboard_WriteText,
  Wi: _YaGamesPrivate_DeviceInfo_IsDesktop,
  Vi: _YaGamesPrivate_DeviceInfo_IsMobile,
  Ui: _YaGamesPrivate_DeviceInfo_IsTV,
  Ti: _YaGamesPrivate_DeviceInfo_IsTablet,
  Si: _YaGamesPrivate_DeviceInfo_Type,
  Ri: _YaGamesPrivate_Environment,
  Qi: _YaGamesPrivate_Event_Dispatch,
  Pi: _YaGamesPrivate_Event_On,
  Oi: _YaGamesPrivate_Features_GameplayAPI_Start,
  Ni: _YaGamesPrivate_Features_GameplayAPI_Stop,
  Mi: _YaGamesPrivate_Features_LoadingAPI_Ready,
  Li: _YaGamesPrivate_Feedback_CanReview,
  Ki: _YaGamesPrivate_Feedback_RequestReview,
  Ji: _YaGamesPrivate_GetFlags,
  Ii: _YaGamesPrivate_GetLeaderboards,
  Hi: _YaGamesPrivate_GetPayments,
  Gi: _YaGamesPrivate_GetPlayer,
  Fi: _YaGamesPrivate_GetStorage,
  Ei: _YaGamesPrivate_IsAvailableMethod,
  Di: _YaGamesPrivate_Leaderboards_GetDescription,
  Ci: _YaGamesPrivate_Leaderboards_GetEntries,
  Bi: _YaGamesPrivate_Leaderboards_GetPlayerEntry,
  Ai: _YaGamesPrivate_Leaderboards_SetScore,
  zi: _YaGamesPrivate_OpenAuthDialog,
  yi: _YaGamesPrivate_Payments_ConsumePurchase,
  xi: _YaGamesPrivate_Payments_GetCatalog,
  wi: _YaGamesPrivate_Payments_GetPurchases,
  vi: _YaGamesPrivate_Payments_Purchase,
  ui: _YaGamesPrivate_Player_GetData,
  ti: _YaGamesPrivate_Player_GetID,
  si: _YaGamesPrivate_Player_GetIDsPerGame,
  ri: _YaGamesPrivate_Player_GetMode,
  qi: _YaGamesPrivate_Player_GetName,
  pi: _YaGamesPrivate_Player_GetPayingStatus,
  oi: _YaGamesPrivate_Player_GetPersonalInfo,
  ni: _YaGamesPrivate_Player_GetPhoto,
  mi: _YaGamesPrivate_Player_GetSignature,
  li: _YaGamesPrivate_Player_GetStats,
  ki: _YaGamesPrivate_Player_GetUniqueID,
  ji: _YaGamesPrivate_Player_IncrementStats,
  ii: _YaGamesPrivate_Player_SetData,
  hi: _YaGamesPrivate_Player_SetStats,
  gi: _YaGamesPrivate_RegisterCallbacks,
  fi: _YaGamesPrivate_RemoveCallbacks,
  ei: _YaGamesPrivate_Screen_Fullscreen_Exit,
  di: _YaGamesPrivate_Screen_Fullscreen_Request,
  ci: _YaGamesPrivate_Screen_Fullscreen_Status,
  bi: _YaGamesPrivate_ServerTime,
  ai: _YaGamesPrivate_Shortcut_CanShowPrompt,
  $h: _YaGamesPrivate_Shortcut_ShowPrompt,
  _h: _YaGamesPrivate_Storage_Clear,
  Zh: _YaGamesPrivate_Storage_GetItem,
  Yh: _YaGamesPrivate_Storage_Key,
  Xh: _YaGamesPrivate_Storage_Length,
  Wh: _YaGamesPrivate_Storage_RemoveItem,
  Vh: _YaGamesPrivate_Storage_SetItem,
  Uh: _YaMetrica_Hit,
  Th: _YaMetrica_NotBounce,
  Sh: _YaMetrica_Params,
  Rh: _YaMetrica_ReachGoal,
  Qh: _YaMetrica_UserParams,
  b: ___assert_fail,
...
var _wasm_call_ctors = function ___wasm_call_ctors() {
  return (_wasm_call_ctors = wasmExports["ij"])();
};
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function () {
  return (_dmExportedSymbols = Module["_dmExportedSymbols"] = wasmExports["jj"])();
};
var _main = Module["_main"] = function (a0, a1) {
  return (_main = Module["_main"] = wasmExports["kj"])(a0, a1);
};
var _malloc = Module["_malloc"] = function (a0) {
  return (_malloc = Module["_malloc"] = wasmExports["lj"])(a0);
};
var _free = Module["_free"] = function (a0) {
  return (_free = Module["_free"] = wasmExports["mj"])(a0);
};
var _htonl2 = function _htonl(a0) {
  return (_htonl2 = wasmExports["oj"])(a0);
};
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function (a0) {
  return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = wasmExports["pj"])(a0);
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function () {
  return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = wasmExports["qj"])();
};
var _setTempRet = function setTempRet0(a0) {
  return (_setTempRet = wasmExports["rj"])(a0);
};
var _htons2 = function _htons(a0) {
  return (_htons2 = wasmExports["sj"])(a0);
};
var _ntohs2 = function _ntohs(a0) {
  return (_ntohs2 = wasmExports["tj"])(a0);
};
var _JSWriteDump = Module["_JSWriteDump"] = function (a0) {
  return (_JSWriteDump = Module["_JSWriteDump"] = wasmExports["uj"])(a0);
};
var _setThrew2 = function _setThrew(a0, a1) {
  return (_setThrew2 = wasmExports["vj"])(a0, a1);
};
var _stackSave = function stackSave() {
  return (_stackSave = wasmExports["wj"])();
};
var _stackRestore = function stackRestore(a0) {
  return (_stackRestore = wasmExports["xj"])(a0);
};
var _stackAlloc = function stackAlloc(a0) {
  return (_stackAlloc = wasmExports["yj"])(a0);
};
var dynCall_jii = Module["dynCall_jii"] = function (a0, a1, a2) {
  return (dynCall_jii = Module["dynCall_jii"] = wasmExports["zj"])(a0, a1, a2);
};
var dynCall_ji = Module["dynCall_ji"] = function (a0, a1) {
  return (dynCall_ji = Module["dynCall_ji"] = wasmExports["Aj"])(a0, a1);
};
